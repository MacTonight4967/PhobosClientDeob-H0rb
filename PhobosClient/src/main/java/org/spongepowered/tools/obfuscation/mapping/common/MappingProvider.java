...
/* 45 */   protected final BiMap<String, String> packageMap = HashBiMap.create();
/* 46 */   protected final BiMap<String, String> classMap = HashBiMap.create();
/* 47 */   protected final BiMap<MappingField, MappingField> fieldMap = HashBiMap.create();
/* 48 */   protected final BiMap<MappingMethod, MappingMethod> methodMap = HashBiMap.create();
/*    */   
...
/* Location:              C:\Users\deadc\Downloads\CLEAN_Phobos-1.9.0-Compatible_By_H0rb.jar!\org\spongepowered\tools\obfuscation\mapping\common\MappingProvider.class
